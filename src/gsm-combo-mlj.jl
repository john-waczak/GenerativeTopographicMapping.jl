...
function GSMCombo(; k=10, m=5, Nv=3, λe=0.01, λw=0.1, make_positive=false, nepochs=100, tol=1e-3, nconverged=4, rng=123)
    model = GSMCombo(k, m, Nv, λe, λw, make_positive, nepochs, tol, nconverged, mk_rng(rng))
