...
function GSMBigLinear(; n_nodes=1000, Nv=3, λ=0.1, make_positive=false, nepochs=100, tol=1e-3, nconverged=4, rng=123)
    model = GSMBigLinear(n_nodes, Nv, λ, make_positive, nepochs, tol, nconverged, mk_rng(rng))
