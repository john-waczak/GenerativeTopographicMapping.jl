function GSMMultUpBigNonlinearBase(n_nodes, n_rbfs, Nᵥ, s, X; rand_init=true, rng=mk_rng(123))
    ...
    return GSMMultUpNonlinearBase(Z, M, s, Φ, W, Ψ, zeros(n_nodes, n_records), R, β⁻¹, πk)
end
